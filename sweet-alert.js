...
sweetAlert.loading = swal.loading = function(reloadMessage){
  ...
  swal({
    title: "",
    text: "<span style='color:#575757;font-weight:600 !important;font-size:25px !important;'>"+
            (reloadMessage == undefined ? "Aguarde o fim da requisição..." : reloadMessage) +
          "</span>",
    html: true,
    ...
    closeOnCancel: false,
    imageUrl: '../component/swal_loading.gif'
  });
};
  ...
  switch (e.type) {
    ...
    case 'click':
      ...
      if (targetedConfirm && doneFunctionExists && modalIsVisible) {
        handleConfirm(modal, params,e);
      } else if (doneFunctionExists && modalIsVisible || targetedOverlay) {
        handleCancel(modal, params,e);
 ...
 */
var handleConfirm = function handleConfirm(modal, params,e) {
  ...
  params.doneFunction(callbackValue,e);
 ...
 */
var handleCancel = function handleCancel(modal, params,e) {
  // Check if callback function expects a parameter (to track cancel actions)
  var functionAsStr = String(params.doneFunction).replace(/\s/g, '');
  var functionHandlesCancel = functionAsStr.substring(0, 9) === 'function(' && functionAsStr.substring(9, 10) !== ')';

  if (functionHandlesCancel) {
    params.doneFunction(false,e);
  }
